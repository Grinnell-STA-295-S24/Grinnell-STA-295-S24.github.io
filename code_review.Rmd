...
**NOTE**: Scores will be based on the students ability to discuss the code submitted for homework 6, and identify errors in the code and articulate solutions. However, it will *not* be based on whether the original code itself contained errors.
